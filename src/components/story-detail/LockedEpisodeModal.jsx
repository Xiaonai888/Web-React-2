...
registerTranslationNamespace('lockedEpisodeModal', {
  en: {
    ...
    allReleasedUnavailable: 'All Released Episodes works when the story has at least 70 released locked episodes.',
    off: '{{count}}% Off',
    access: 'Access',
    unlocking: 'Unlocking...',
  ...
  km: {
    ...
    allReleasedUnavailable: 'ជម្រើសភាគដែលបានចេញទាំងអស់ អាចប្រើបាននៅពេលមានភាគដែលបានចេញ និងជាប់សោចាប់ពី 70 ភាគឡើងទៅ។',
    off: 'បញ្ចុះ {{count}}%',
    access: 'ចូលអាន',
  ...
  zh: {
    ...
    allReleasedUnavailable: '当故事有至少 70 个已发布且锁定的章节时，才可使用全部已发布章节。',
    off: '优惠 {{count}}%',
    access: '访问',
    unlocking: '正在解锁...',
    loginToUnlock: '登录后解锁',
  ...
  ja: {
    ...
    allReleasedUnavailable: '公開済み全エピソードは、公開済みのロックされたエピソードが70話以上ある場合に利用できます。',
    off: '{{count}}% オフ',
    access: 'アクセス',
    unlocking: '解除中...',
  ...
  ko: {
    ...
    allReleasedUnavailable: '공개된 잠금 에피소드가 70개 이상인 경우 전체 공개 에피소드를 이용할 수 있습니다.',
    off: '{{count}}% 할인',
    access: '이용',
    unlocking: '잠금 해제 중...',
...
const FALLBACK_REASON_KEYS = {
  ...
  'All Released Episodes works when the story has at least 70 released locked episodes.': 'allReleasedUnavailable',
}
...
function buildFallbackPackageOptions(price = FALLBACK_DIAMOND_PRICE) {
  return [
    ...
    },
    {
      ...
      original_price: 5000,
      price: 3000,
      disabled_reason: 'All Released Episodes works when the story has at least 70 released locked episodes.',
    },
  ]
}
