...
registerTranslationNamespace('premiumBannerSection', {
  en: {
    title: 'Premium Reader',
    subtitle: 'Unlock more stories and premium perks',
  },
  km: {
    title: 'អ្នកអាន Premium',
    subtitle: 'បើកអានរឿងបន្ថែម និងទទួលអត្ថប្រយោជន៍ Premium',
  },
  zh: {
    title: 'Premium 读者',
    subtitle: '解锁更多故事和 Premium 专属福利',
  },
  ja: {
    title: 'Premium リーダー',
    subtitle: 'より多くの作品と Premium 特典を解放',
  },
  ko: {
    title: 'Premium 리더',
    subtitle: '더 많은 작품과 Premium 혜택을 이용하세요',
  },
})
