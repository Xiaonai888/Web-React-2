...
export default function SocialEchoShareSheetV2({
  open,
  sourceType = '',
  sourceId,
  sourceName = 'Shadow',
    ...
    <div className="fixed inset-0 z-[200000] flex items-end justify-center">
      ...
      {toastMessage ? (
        <div
          role="status"
          aria-live="polite"
          className={`pointer-events-none fixed left-1/2 top-[calc(12px+env(safe-area-inset-top))] z-[200030] w-[calc(100%-32px)] max-w-[420px] -translate-x-1/2 rounded-[14px] bg-[#111827] px-4 py-3 text-center text-[12px] font-normal leading-5 text-white shadow-xl transition-all duration-300 ${
            toastVisible
