...
function PackageCard({ item, onPurchase }) {
  ...
  <div className="min-w-0 flex-1">
    <div className="relative -top-[2px] flex items-baseline gap-1.5">
      ...
      <span className="text-[12px] font-black text-[var(--shadow-text-primary)]">Diamonds</span>
    </div>
    ...
    <div className="fixed inset-0 z-[9999] flex items-end justify-center bg-black/60 sm:items-center sm:px-4">
      <div className="w-full rounded-t-[28px] bg-[var(--shadow-bg-elevated)] p-5 text-[var(--shadow-text-primary)] shadow-2xl sm:max-w-[430px] sm:rounded-[28px]">
        <div className="mb-5 flex items-start justify-between gap-4">
          <div>
            <h3 className="text-[20px] font-black text-[var(--shadow-text-primary)]">Payment Method</h3>
  ...
  <div className="fixed inset-0 z-[9999] flex items-end justify-center bg-black/60 px-4 pb-4 sm:items-center sm:pb-0">
      <div className="w-full max-w-[460px] rounded-[28px] bg-[var(--shadow-bg-elevated)] p-5 text-[var(--shadow-text-primary)] shadow-2xl">
        ...
        <div className="rounded-[22px] border border-[var(--shadow-border)] bg-[var(--shadow-bg-soft)] p-4">
          ...
          {payment.aba_trx_id ? <p className="mt-1 break-all text-[11px] font-bold text-[var(--shadow-text-secondary)]">Trx ID: {payment.aba_trx_id}</p> : null}
        </div>
  ...
  if (!getReaderToken()) {
    return (
      <section className="rounded-[24px] border border-[var(--shadow-border)] bg-[var(--shadow-bg-surface)] p-6 text-center shadow-[0_6px_16px_rgba(17,17,17,0.035)]">
        <h2 className="text-[20px] font-black text-[var(--shadow-text-primary)]">Purchase Diamonds</h2>
...
>
  ...
  <DiamondIcon size="h-10 w-10" />
            ...
            <p className="mt-2 text-[13px] font-bold text-[var(--shadow-text-primary)]">120 Diamonds</p>
          </div>
  ...
  />
            ...
            <p className="mt-2 text-[13px] font-bold text-[var(--shadow-text-primary)]">Early Access</p>
          </div>
  ...
  />
            ...
            <p className="mt-2 text-[13px] font-bold text-[var(--shadow-text-primary)]">Free 7 Stories</p>
          </div>
        </div>
      </div>
...
<div>
  ...
  <h3 className="text-[14px] font-bold text-[var(--shadow-text-primary)]">Purchase Notes</h3>
