    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        <div className="min-w-0 flex-1">
          <div className="text-[10px] font-semibold uppercase tracking-[0.08em] text-[#98a2b3] dark:text-white/40">STORY</div>
          ...
          {genre && genre !== summary ? (
            <div className="mt-1 text-[11px] font-normal text-[#98a2b3] dark:text-white/40">{genre}</div>
          ) : null}
        </div>
