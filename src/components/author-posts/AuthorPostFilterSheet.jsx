...
function CalendarDialog({ open, value, onClose, onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 z-[350] flex items-center justify-center bg-black/40 px-4">
      ...
      <section
        className="relative z-10 w-full max-w-[360px] overflow-hidden rounded-[20px] bg-white shadow-2xl"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="px-4 pb-3 pt-4">
          <div className="flex items-center justify-between">
            ...
            <div className="min-w-0 px-2 text-center text-[15px] font-medium text-[#111827]">
              {monthLabel}
            </div>
          ...
          <div className="mt-3 grid grid-cols-7 text-center">
            {WEEKDAYS.map((day) => (
              <div
                key={day}
                className="py-2 text-[12px] font-medium text-[#6b7280]"
              >
                {day}
              </div>
            ))}
        ...
        <div className="flex items-center justify-end gap-1 border-t border-[#eef0f4] px-3 py-2">
          <button
            type="button"
            onClick={chooseToday}
          ...
          <button
            type="button"
            onClick={confirmDate}
            className="rounded-[10px] bg-[#111827] px-4 py-2 text-[13px] font-medium text-white active:scale-[0.98]"
          >
            OK
          </button>
        </div>
          ...
          <div className="border-t border-[#e5e7eb] pt-4">
            <div className="flex items-center justify-between gap-3">
              ...
              <button
                ...
                className="flex h-12 min-w-0 max-w-[190px] shrink-0 items-center justify-center gap-2 rounded-[14px] bg-[#edf0f4] px-3 text-[#111827] active:scale-[0.99] sm:min-w-[160px]"
              >
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={handleClear}
                className="h-12 rounded-[14px] bg-[#edf0f4] text-[14px] font-normal text-[#111827] active:scale-[0.99]"
              >
                Clear
              </button>
