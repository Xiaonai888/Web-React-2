...
export default function ForYou() {
  ...
  useEffect(() => {
    // បង្កើត Swiper ធំ (Big Slide) តាមរយៈ window.Swiper (CDN)
    if (window.Swiper) {
  ...
  return (
    <>
      <style>{`
        ...
        .tab-item { transition:all 0.3s ease; cursor:pointer; position:relative; padding-bottom: 8px; }
        .tab-item.active { color:#3b82f6; font-weight:700; }
        .tab-item.active::after { content:''; position:absolute; bottom:0; left:0; width:100%; height:3px; background:#3b82f6; border-radius:10px; }
      `}</style>
