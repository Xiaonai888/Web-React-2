...
registerTranslationNamespace('readerSecuritySettingsPage', {
  en: {
    ...
    emailDescription: 'Require a 6-digit email code when you sign in.', pinTitle: '6-digit login PIN',
    ...
    code: 'Email code', pin: 'New 6-digit PIN', confirmPin: 'Confirm new PIN',
    confirm: 'Confirm', cancel: 'Cancel', sending: 'Sending...', saving: 'Saving...',
    codeRequired: 'Enter the 6-digit code.', pinRequired: 'Enter a 6-digit PIN.',
  ...
  km: {
    ...
    emailDescription: 'តម្រូវឱ្យបញ្ចូលកូដ ៦ ខ្ទង់ពីអ៊ីមែលពេលចូលគណនី។', pinTitle: 'PIN ចូលគណនី ៦ ខ្ទង់',
    ...
    code: 'កូដអ៊ីមែល', pin: 'PIN ថ្មី ៦ ខ្ទង់', confirmPin: 'បញ្ជាក់ PIN ថ្មី',
    confirm: 'បញ្ជាក់', cancel: 'បោះបង់', sending: 'កំពុងផ្ញើ...', saving: 'កំពុងរក្សាទុក...',
    codeRequired: 'សូមបញ្ចូលកូដ ៦ ខ្ទង់។', pinRequired: 'សូមបញ្ចូល PIN ៦ ខ្ទង់។',
  ...
  zh: {
    ...
    emailDescription: '登录时需要输入邮箱收到的6位验证码。', pinTitle: '6位登录 PIN',
    ...
    code: '邮箱验证码', pin: '新的6位 PIN', confirmPin: '确认新 PIN',
    confirm: '确认', cancel: '取消', sending: '发送中...', saving: '保存中...',
    codeRequired: '请输入6位验证码。', pinRequired: '请输入6位 PIN。',
  ...
  ja: {
    ...
    emailDescription: 'ログイン時にメールの6桁コードを要求します。', pinTitle: '6桁のログインPIN',
    ...
    code: 'メールコード', pin: '新しい6桁のPIN', confirmPin: '新しいPINを再入力',
    confirm: '確認', cancel: 'キャンセル', sending: '送信中...', saving: '保存中...',
    codeRequired: '6桁のコードを入力してください。', pinRequired: '6桁のPINを入力してください。',
  ...
  ko: {
    ...
    emailDescription: '로그인할 때 이메일로 받은 6자리 코드를 입력합니다.', pinTitle: '6자리 로그인 PIN',
    ...
    code: '이메일 코드', pin: '새 6자리 PIN', confirmPin: '새 PIN 확인',
    confirm: '확인', cancel: '취소', sending: '전송 중...', saving: '저장 중...',
    codeRequired: '6자리 코드를 입력해 주세요.', pinRequired: '6자리 PIN을 입력해 주세요.',
