...
function uploadReaderStory({ file, caption, allowMessages, token, onProgress }) {
  return new Promise((resolve, reject) => {
    ...
    request.open('POST', `${API_BASE_URL}/api/reader-stories/me`)
...
export default function CreateReaderStoryPage() {
  ...
  async function handlePublish() {
    ...
    try {
      ...
      const story = await uploadReaderStory({
        file: mediaFile,
              ...
              <div className="mt-3 overflow-hidden rounded-[24px] border border-white/10 bg-white/[0.045] backdrop-blur-2xl">
                ...
                <div className="flex items-center gap-3 px-4 py-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 text-[10px] font-semibold text-white/40">People can reply to your story</div>
                  </div>
