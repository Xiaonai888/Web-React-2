...
registerTranslationNamespace('shadowMallSecondHandPage', {
  en: { "latest": "Latest", "priceLow": "Price Low", "priceHigh": "Price High", "soldOut": "SOLD OUT", "preOrder": "PRE-ORDER", "inStock": "IN STOCK", "untitledBook": "Untitled book", "unknownAuthor": "Unknown author", "secondHandBadge": "SECOND HAND", "removeSaved": "Remove saved", "save": "Save", "addToCart": "Add {{title}} to cart", "failedLoad": "Failed to load Second Hand books", "goBack": "Go back", "title": "Second Hand", "booksSummary": "{{count}} books · Checked condition, lower price, limited stock.", "searchBooks": "Search Second Hand books", "heroTitle": "{t('shadowMallSecondHandPage.heroTitle')}", "heroBody": "{t('shadowMallSecondHandPage.heroBody')}", "searchPlaceholder": "Search second hand books or authors", "clearSearch": "Clear search", "noBooks": "No second hand books found", "noBooksBody": "{t('shadowMallSecondHandPage.noBooksBody')}", "backMall": "Back to Shadow Mall", "previous": "Previous", "pageOf": "Page {{page}} / {{total}}", "next": "Next" },
