...
registerTranslationNamespace('shadowMallCheckoutPage', {
  en: { "closeBuyerProfile": "Close Buyer Profile", "buyerProfile": "Buyer Profile", "printedDeliveryRequired": "Required for printed book delivery.", "loadingBuyerProfile": "Loading buyer profile...", "name": "Name", "nameHelp": "Name comes from your reader account. To change it, update your main profile.", "phoneNumber": "Phone Number", "enterPhone": "Enter phone number", "pleaseLoginFirst": "Please login first", "deliveryAddress": "Delivery Address", "addressPlaceholder": "House number, street, village, commune, district, province/city...", "saving": "Saving...", "saveInformation": "Save Information", "failedLoadProfile": "Failed to load buyer profile", "loginBeforeSave": "Please login before saving buyer profile.", "profileRequired": "Phone number and delivery address are required.", "failedSaveProfile": "Failed to save buyer profile", "loginBeforeCheckout": "Please login before checkout.", "cartEmpty": "Your cart is empty.", "failedCreatePayment": "Failed to create Shadow Mall payment", "paymentNotCreated": "Payment order was not created", "failedContinuePayment": "Failed to continue payment", "goBack": "Go back", "checkout": "Checkout", "openBuyerProfile": "Open Buyer Profile", "deliveryCompany": "Delivery Company", "chooseDeliveryCompany": "Choose the company for printed book delivery.", "deliveryNote": "Delivery Note", "notePlaceholder": "Optional note for admin or delivery...", "orderItems": "Order Items", "booksInOrder": "{{count}} books in this order", "noBooksCart": "No books in cart", "backToShop": "Back to Shop", "paymentSummary": "Payment Summary", "subtotal": "Subtotal", "deliveryFee": "Delivery Fee", "total": "Total", "openingPayWay": "Opening PayWay...", "continuePayment": "Continue to Payment", "loginCheckout": "Login to Checkout", "untitledBook": "Untitled book", "unknownAuthor": "Unknown author", "each": "each", "removeItem": "Remove {{title}}", "telegramUsername": "Telegram Username", "facebookLink": "Facebook Link", "facebookPlaceholder": "Paste Facebook profile or Messenger link", "quantity": "Qty: {{count}}", "provinceCity": "Province / City", "addressPlaceholderShort": "House number, street, village, commune, district..." },
