...
registerTranslationNamespace('shadowMallRecentlySoldOutPage', {
  en: { "latestSoldOut": "Latest Sold Out", "priceLow": "Price Low", "priceHigh": "Price High", "untitledBook": "Untitled book", "unknownAuthor": "Unknown author", "soldOut": "SOLD OUT", "recentlySold": "RECENTLY SOLD", "removeSaved": "Remove saved", "save": "Save", "soldOutAria": "{{title}} is sold out", "failedLoad": "Failed to load Recently Sold Out books", "goBack": "Go back", "title": "Recently Sold Out", "booksSummary": "{{count}} books · Popular books that sold out recently.", "searchBooks": "Search Recently Sold Out books", "heroTitle": "Popular books that disappeared fast", "heroBody": "These books are currently sold out. Save them to your wishlist and check again when stock returns.", "searchPlaceholder": "Search sold out books or authors", "clearSearch": "Clear search", "noBooks": "No sold out books found", "noBooksBody": "Try another search or check Recently Sold Out again later.", "backMall": "Back to Shadow Mall", "previous": "Previous", "pageOf": "Page {{page}} / {{total}}", "next": "Next" },
