...
registerTranslationNamespace('manageLibraryPage', {
  en: {
    ...
    cacheDescription: 'Manage storage', downloadsDescription: 'Manage downloaded stories',
  ...
  km: {
    ...
    cacheDescription: 'គ្រប់គ្រងទំហំផ្ទុក', downloadsDescription: 'គ្រប់គ្រងរឿងដែលបានទាញយក',
  ...
  ko: {
    ...
    cacheDescription: '저장 공간 관리', downloadsDescription: '다운로드한 스토리 관리',
