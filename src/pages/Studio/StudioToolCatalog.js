export const STUDIO_TOOL_GROUPS = [
  ...
  { id: 'other', tools: [
    ...
    { id: 'filter', icon: 'fa-sliders' },
  ] },
]

export const STUDIO_WORKING_TOOLS = new Set(STUDIO_TOOL_GROUPS.flatMap((group) => group.tools.map((item) => item.id)))
