...
/**
 * ShadowExclusivePage Component
 * A premium, curated library for Shadow Premium members.
 */
const ShadowExclusivePage = () => {
  ...
  const shadowPicks = [
    { id: 1, title: 'The Silent Archon', chapter: 'Ch. 42', genre: 'Dark Fantasy', image: 'https://images.unsplash.com/photo-1543003919-a9957004550d?auto=format&fit=crop&q=80&w=400' },
    { id: 2, title: 'Velvet Requiem', chapter: 'Ch. 15', genre: 'Romance', image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&q=80&w=400' },
    { id: 3, title: 'Neon Syndicate', chapter: 'Ch. 89', genre: 'Sci-Fi', image: 'https://images.unsplash.com/photo-1614728263952-84ea256f9679?auto=format&fit=crop&q=80&w=400' },
    { id: 4, title: 'Ethereal Contract', chapter: 'Ch. 04', genre: 'Supernatural', image: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=crop&q=80&w=400' },
  ];

  const moonlitChemistry = [
    { id: 5, title: 'Pulse of the Abyss', chapter: 'Ch. 22', genre: 'Psychological', image: 'https://images.unsplash.com/photo-1509248961158-e54f6934749c?auto=format&fit=crop&q=80&w=400' },
    { id: 6, title: 'Gilded Chains', chapter: 'Ch. 56', genre: 'Drama', image: 'https://images.unsplash.com/photo-1589998059171-988d887df646?auto=format&fit=crop&q=80&w=400' },
    { id: 7, title: 'The Last Oracle', chapter: 'Ch. 12', genre: 'Mystery', image: 'https://images.unsplash.com/photo-1516589174418-0a114486689d?auto=format&fit=crop&q=80&w=400' },
    { id: 8, title: 'Stellar Drifters', chapter: 'Ch. 31', genre: 'Adventure', image: 'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?auto=format&fit=crop&q=80&w=400' },
  ];

  const arcaneVault = [
    { id: 9, title: 'Bloodline Legacy', chapter: 'Ch. 104', genre: 'Action', image: 'https://images.unsplash.com/photo-1511919884226-fd3cad34687c?auto=format&fit=crop&q=80&w=400' },
    { id: 10, title: 'Midnight Protocol', chapter: 'Ch. 09', genre: 'Thriller', image: 'https://images.unsplash.com/photo-1505664194779-8beaceb93744?auto=format&fit=crop&q=80&w=400' },
    { id: 11, title: 'Aurelian Dawn', chapter: 'Ch. 45', genre: 'Epic Fantasy', image: 'https://images.unsplash.com/photo-1478720568477-152d9b164e26?auto=format&fit=crop&q=80&w=400' },
    { id: 12, title: 'Iron Serpent', chapter: 'Ch. 18', genre: 'Martial Arts', image: 'https://images.unsplash.com/photo-1533109721025-d1ae2ee8c1eb?auto=format&fit=crop&q=80&w=400' },
  ];
  ...
  const ComicCard = ({ title, image, chapter, genre }) => (
    <div className="group relative flex flex-col cursor-pointer transition-all duration-500 hover:-translate-y-1">
      {/* Outer Image Container with Stable Frame */}
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-zinc-300 font-sans selection:bg-amber-400/30">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-black text-white tracking-tight flex items-center gap-2">
                SHADOW VAULT
                <span className="bg-amber-400 text-black text-[9px] px-1.5 py-0.5 rounded-sm font-black">PRO</span>
              </h1>
              <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-[0.2em]">Curated Inner Circle</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto pb-24">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="max-w-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs font-black text-amber-400 uppercase tracking-widest">Premium Access Required</span>
                </div>
                <h2 className="text-3xl font-black text-white mb-2 tracking-tight">The Shadow Membership</h2>
        ...
        {/* 3. RANKING TABS / FILTER SWITCHER */}
        ...
        {/* 4. MAIN CURATED SHELVES */}
        
        {/* Section: Inner Circle Reads */}
        ...
        <section className="mt-24 px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-3xl bg-zinc-900/40 border border-white/5 hover:bg-zinc-900/60 transition-all">
              ...
              <p className="text-xs text-zinc-500 leading-relaxed font-medium">Experience your stories without interruptions. Premium members read pure content only.</p>
            </div>
            <div className="p-6 rounded-3xl bg-zinc-900/40 border border-white/5 hover:bg-zinc-900/60 transition-all">
              <Zap className="w-8 h-8 text-amber-400 mb-4" />
              <h3 className="text-lg font-bold text-white mb-2">Shadow Early Access</h3>
              <p className="text-xs text-zinc-500 leading-relaxed font-medium">Read upcoming chapters 72 hours before anyone else. Stay ahead of the discussion circle.</p>
            </div>
            <div className="p-6 rounded-3xl bg-zinc-900/40 border border-white/5 hover:bg-zinc-900/60 transition-all">
              <Clock className="w-8 h-8 text-emerald-400 mb-4" />
              <h3 className="text-lg font-bold text-white mb-2">Unlimited Vault Offline</h3>
              <p className="text-xs text-zinc-500 leading-relaxed font-medium">Download any curation in the vault to your device for reading in the most remote areas.</p>
            </div>
          </div>
        </section>
          ...
          <div className="bg-gradient-to-r from-[#16161a] to-[#0a0a0c] rounded-3xl border border-white/5 p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500 font-medium">Contact the Shadow concierge for instant support.</p>
              </div>
            </div>
      ...
      {/* 7. BOTTOM NAVIGATION MOCKUP */}
      <nav className="fixed bottom-0 left-0 right-0 z-[100] bg-[#0a0a0c]/80 backdrop-blur-xl border-t border-white/5 px-6 py-3">
        <div className="max-w-md mx-auto flex items-center justify-between">
          <div className="flex flex-col items-center gap-1 text-zinc-500">
            <Clock className="w-5 h-5" />
            <span className="text-[10px] font-black uppercase">Recent</span>
          </div>
          <div className="flex flex-col items-center gap-1 text-zinc-500">
            <Star className="w-5 h-5" />
            <span className="text-[10px] font-black uppercase">Series</span>
          </div>
          <div className="relative -top-6">
            <div className="p-4 bg-amber-400 rounded-full shadow-[0_0_25px_rgba(251,191,36,0.5)] border-4 border-[#0a0a0c]">
              <Lock className="w-6 h-6 text-black" />
            </div>
          </div>
          <div className="flex flex-col items-center gap-1 text-amber-400">
            <Crown className="w-5 h-5" />
            <span className="text-[10px] font-black uppercase tracking-tighter text-amber-400">Vault</span>
          </div>
          <div className="flex flex-col items-center gap-1 text-zinc-500">
