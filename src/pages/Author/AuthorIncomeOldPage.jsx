...
registerTranslationNamespace('authorIncomeOld', {
  en: {
    ...
    automaticMonthlyPayout: 'Manual story payout',
    ...
    tip3: 'When eligible Story Unlock earnings reach $10, Shadow reviews and transfers the payout manually. No withdrawal request is needed; there is no guaranteed transfer date.',
    ...
    week: 'Week',
    total: 'Total',
    nextPayout: 'Payout Status',
    payoutAutomaticBody: 'Story payouts are reviewed and transferred manually once eligible. No withdrawal request is needed.',
  ...
  km: {
    ...
    automaticMonthlyPayout: 'ការបើកប្រាក់ចំណូលរឿងដោយផ្ទាល់',
    ...
    tip3: 'ពេលចំណូលពីការដោះសោរឿងដែលគ្រប់លក្ខខណ្ឌឈានដល់ $10 Shadow នឹងពិនិត្យ និងផ្ទេរប្រាក់ដោយផ្ទាល់។ អ្នកមិនចាំបាច់ស្នើដកប្រាក់ទេ ហើយមិនមានការធានាថានឹងផ្ទេរនៅថ្ងៃណាមួយជាក់លាក់ទេ។',
    ...
    week: 'សប្តាហ៍',
    total: 'សរុប',
    nextPayout: 'ស្ថានភាពទទួលប្រាក់',
    payoutAutomaticBody: 'Shadow ពិនិត្យ និងផ្ទេរប្រាក់ចំណូលរឿងដែលគ្រប់លក្ខខណ្ឌដោយផ្ទាល់។ អ្នកមិនចាំបាច់ស្នើដកប្រាក់ទេ។',
  ...
  zh: {
    ...
    automaticMonthlyPayout: '故事收益人工付款',
    monthlyPayout: '每月付款',
    netPayout: '净付款',
    statusPaid: '已支付',
    statusFailed: '失败',
    ...
    tip3: '当符合条件的故事解锁收入达到 $10 时，Shadow 会审核并手动转账。无需申请提现，也不保证具体转账日期。',
    ...
    total: '总计',
    nextPayout: '付款状态',
    payoutAutomaticBody: 'Shadow 会审核并手动支付符合条件的故事收入，无需申请提现。',
  ...
  ja: {
    ...
    automaticMonthlyPayout: 'ストーリー収益の手動支払い',
    monthlyPayout: '月次支払い',
    netPayout: '受取純額',
    statusPaid: '支払い済み',
    statusFailed: '失敗',
    ...
    tip3: '対象となるストーリー解放収益が $10 に達すると、Shadow が確認して手動で送金します。出金申請は不要ですが、送金日は保証されません。',
    ...
    total: '合計',
    nextPayout: '支払い状況',
    payoutAutomaticBody: '対象となるストーリー収益は Shadow が確認し、手動で送金します。出金申請は不要です。',
  ...
  ko: {
    ...
    automaticMonthlyPayout: '스토리 수익 수동 지급',
    monthlyPayout: '월 지급',
    netPayout: '순 지급액',
    statusPaid: '지급 완료',
    statusFailed: '실패',
    ...
    tip3: '지급 대상 스토리 잠금 해제 수익이 $10에 도달하면 Shadow가 검토한 뒤 수동으로 송금합니다. 출금 신청은 필요하지 않으며 특정 송금일은 보장되지 않습니다.',
    ...
    total: '전체',
    nextPayout: '지급 상태',
    payoutAutomaticBody: 'Shadow가 지급 조건을 충족한 스토리 수익을 검토하고 수동으로 송금합니다. 출금 신청은 필요하지 않습니다.',
