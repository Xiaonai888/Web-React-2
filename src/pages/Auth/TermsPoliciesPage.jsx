    ...
    <div className="min-h-screen bg-[#eeeeee] pb-12">
      ...
      <main className="mx-auto max-w-3xl px-4 pt-10">
        <article className="rounded-[26px] bg-white px-6 py-8 text-[#151515] shadow-sm sm:px-9 sm:py-10">
          <div className="mb-4 flex flex-wrap items-center gap-x-5 gap-y-1 text-[18px]">
            <span className="font-extrabold">Effective Date:</span>
            <span>21/12/2025</span>
          </div>

          <h2 className="mb-4 text-[20px] font-extrabold">Welcome to Shadowera</h2>

          <p className="mb-7 text-[18px] leading-8">
          ...
          <section className="mb-7">
            <h3 className="mb-4 text-[24px] font-extrabold">1. User Accounts</h3>
            <ul className="list-disc space-y-2 pl-7 text-[18px] leading-8">
          ...
          <section className="mb-7">
            <h3 className="mb-4 text-[24px] font-extrabold">2. User Conduct</h3>
            <ul className="list-disc space-y-2 pl-7 text-[18px] leading-8">
          ...
          <section className="mb-7">
            <h3 className="mb-4 text-[24px] font-extrabold">3. Content Ownership</h3>
            <ul className="list-disc space-y-2 pl-7 text-[18px] leading-8">
          ...
          <section className="mb-7">
            <h3 className="mb-4 text-[24px] font-extrabold">4. Fraud and Misuse</h3>
            <ul className="list-disc space-y-2 pl-7 text-[18px] leading-8">
              <li>
          ...
          <section className="mb-7">
            <h3 className="mb-4 text-[24px] font-extrabold">5. Intellectual Property</h3>
            <ul className="list-disc space-y-2 pl-7 text-[18px] leading-8">
          ...
          <section className="mb-7">
            <h3 className="mb-4 text-[24px] font-extrabold">6. Content Moderation</h3>
            <ul className="list-disc space-y-2 pl-7 text-[18px] leading-8">
              <li>We reserve the right to remove or edit content that violates our policies without prior notice.</li>
              <li>Decisions made by our moderation team are final.</li>
            </ul>
          ...
          <section className="mb-7">
            <h3 className="mb-4 text-[24px] font-extrabold">7. Account Termination</h3>
            <ul className="list-disc space-y-2 pl-7 text-[18px] leading-8">
          ...
          <section className="mb-7">
            <h3 className="mb-4 text-[24px] font-extrabold">8. Disclaimer</h3>
            <ul className="list-disc space-y-2 pl-7 text-[18px] leading-8">
          ...
          <section className="mb-7">
            <h3 className="mb-4 text-[24px] font-extrabold">9. Changes to the Terms</h3>
            <ul className="list-disc space-y-2 pl-7 text-[18px] leading-8">
          ...
          <section>
            <h3 className="mb-4 text-[24px] font-extrabold">10. Contact Us</h3>
            <p className="mb-2 text-[18px] leading-8">
              If you have any questions or concerns about these Terms, please contact us at:
            </p>
            <ul className="list-disc space-y-1 pl-7 text-[18px] leading-8">
