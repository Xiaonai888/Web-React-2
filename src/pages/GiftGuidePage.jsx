...
const GUIDE_SECTIONS = [
  {
    title: '1. 100% of Diamond Gifts Go to Authors',
    body: [
      'When you send a Gift using Diamonds, 100% of the Gift value goes to the author.',
      'Shadow does not take any share from Diamond Gifts.',
      'Gifts sent with Coins are for support and ranking only and do not generate earnings for the author.',
    ],
  },
  {
    title: '2. What is a Gift?',
    body: [
  ...
  {
    title: '3. What can I use to send Gifts?',
    body: [
  ...
  {
    title: '8. All rights reserved by Shadow.',
    body: [
